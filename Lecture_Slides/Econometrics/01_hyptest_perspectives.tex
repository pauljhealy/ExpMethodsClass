...
\begin{frame}{Primer: One-Sided Test}
    ...
    \begin{center}
        \includegraphics[height=1.5in]{graphics/PowerFunctionNormalEx.png}
    \end{center}
...
\begin{frame}{Example MATLAB Simulation}
    \centering
    \includegraphics[width=4in]{graphics/simplehypsim.png}
\end{frame}

\begin{frame}{Example MATLAB Simulation}
    \centering
    \includegraphics[width=4in]{graphics/simplehypsim2.png}
\end{frame}
...
\centering
\includegraphics[width=4in]{graphics/PowerFunctionTwoSidedTTest.png}\\
$x$-axis: True mean. Blue: Power function. Red: Average $p$-value.
\end{frame}

\begin{frame}{Primer: Two-Sided Test}
\centering
\includegraphics[width=4in]{graphics/PowerFunctionTwoSidedTTestHighVar.png}\\
Double the variance
\end{frame}
...
\begin{columns}
    ...
    \centering
    \includegraphics[width=1\linewidth]{graphics/dist.pdf}
\end{columns}
\end{frame}
...
\begin{columns}[T]
        ...
        \includegraphics[width=1\linewidth]{graphics/score.pdf}
        \end{figure}
...
\framesubtitle{The paper has the logical relationship between all perspectives 1--15 along with their validity \& consistency}
	\begin{columns}
		...
		\begin{figure}
			\centering
			\includegraphics[width=1\linewidth]{graphics/perspectives}
