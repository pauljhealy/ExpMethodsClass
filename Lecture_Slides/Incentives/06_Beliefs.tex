...
\begin{frame}{Theory: Savage (1971)}
    \begin{center}
        ...
        \includegraphics[width=1.34in]{graphics/blf/savage54.jpg} &
        \includegraphics[width=2.66in]{graphics/blf/savage71.jpg} \\
        (1954) & (1971)
        \end{tabular}
    \end{center}
\end{frame}
...
\begin{center}
    \includegraphics[width=4.5in]{graphics/blf/ScoringRuleGs.png}
\end{center}
\end{frame}
...
\begin{frame}{The Lambert Characterization}
\begin{center}
    \includegraphics[width=4in]{graphics/blf/Lambert1.png}
\end{center}
...
\begin{frame}{The Lambert Characterization}
\begin{center}
    \includegraphics[width=4in]{graphics/blf/Lambert2.png}
\end{center}
Median: yes!
\end{frame}
...
\begin{frame}{The Lambert Characterization}
\begin{center}
    \includegraphics[width=4in]{graphics/blf/Lambert3.png}
\end{center}
Mode: yes!
\end{frame}
...
\begin{frame}{The Lambert Characterization}
\begin{center}
    \includegraphics[width=4in]{graphics/blf/Lambert4.png}
\end{center}
...
\setbeamercolor{background canvas}{bg=white}
 ...
 \begin{center}
     \foreach \x in {1,...,11} {
         \only<\x>{\includegraphics[scale=0.4]{graphics/blf/screens/a\x}\br}
         \only<\x>{\includegraphics[scale=0.5]{graphics/blf/screens/b\x}}
     }
 \end{center}    
 \end{frame}
...
\begin{center}
    \only<1>{\includegraphics[scale=0.5]{graphics/blf/MPL.jpg}}
    \only<2>{\includegraphics[scale=0.4]{graphics/blf/QSR.jpg}}
    \only<3>{\includegraphics[scale=0.5]{graphics/blf/NoInfo.jpg}}\br
...
\begin{center}
    \includegraphics[scale=0.5]{graphics/blf/LockIn.jpg}\includegraphics[scale=0.3]{graphics/blf/Chat.jpg}\br
    \begin{itemize}
...
\begin{frame}{Objective-Easy \#1: \% Correct}
    \begin{center}
        \begin{tabular}{ m{4cm} m{4cm}}
            \includegraphics[width=1.5in]{graphics/blf/urn.jpg} & {\color{purple}Pr(Red) = \uline{12/20 = 60\%}}
        \end{tabular}\br
        \% Correct:\br
        \begin{tabular}{rccc}
...
\begin{frame}{Objective-Easy \#2: \% Correct}
    \begin{center}
        \begin{tabular}{ m{4cm} m{3cm}}
            \includegraphics[width=1.5in]{graphics/blf/twojarsempty.jpg} & {\color{purple}Pr(Red) = \uline{50\%}}
        \end{tabular}\br
        \% Correct:\br
        \begin{tabular}{rccc}
            & \textbf{MPL} & \textbf{BSR} & \textbf{NoInfo}  \\
...
\begin{frame}{Objective-Easy \#3: \% Correct}
    \begin{center}
        \begin{tabular}{ m{4cm} m{3cm}}
            \includegraphics[width=1.5in]{graphics/blf/spin3.jpg} & {\color{purple} Median = \uline{60pts}}
        \end{tabular}\br
        \% Correct:\br
        \begin{tabular}{rccc}
            & \textbf{MPL} & \textbf{BSR} & \textbf{NoInfo}  \\
...
%     \begin{center}
%         \begin{tabular}{ m{4cm} m{3cm}}
%             \includegraphics[width=1.5in]{graphics/blf/spin3.jpg} & {\color{purple} Mean = \uline{55pts}}
%         \end{tabular}\br
%         \% Correct:\br
%         \begin{tabular}{rccc}
%             & \textbf{MPL} & \textbf{BSR} & \textbf{NoInfo}  \\
...
%     \begin{center}
%         \begin{tabular}{ m{4cm} m{3cm}}
%             \includegraphics[width=1.5in]{graphics/blf/spin6.jpg} & {\color{purple} Median = \uline{70pts}}
%         \end{tabular}\br
%         \% Correct:\br
%         \begin{tabular}{rccc}
%             & \textbf{MPL} & \textbf{BSR} & \textbf{NoInfo}  \\
...
%     \begin{center}
%         \begin{tabular}{ m{4cm} m{3cm}}
%             \includegraphics[width=1.5in]{graphics/blf/spin6.jpg} & {\color{purple} Mean $\approx$ \uline{55.2pts?}}
%         \end{tabular}\br
%         \% Correct:\br
%         \begin{tabular}{rccc}
%             & \textbf{MPL} & \textbf{BSR} & \textbf{NoInfo}  \\
...
%     \begin{center}
%         \begin{tabular}{ m{4cm} m{3cm}}
%             \includegraphics[width=1.5in]{graphics/blf/twojars.jpg} & {\color{purple} Pr(Red) = \uline{1/3}}\\
...
%     \begin{center}
%         \begin{tabular}{ m{4cm} m{3cm}}
%             \includegraphics[width=1.5in]{graphics/blf/twojars.jpg} & {\color{purple} Pr(Red) = \uline{1/5}}\\
...
\begin{center}
    \includegraphics[width=11cm]{graphics/blf/errbydiff.png}
\end{center}
\end{frame}
}
...
\begin{center}
    Easy Task misreport \%:\\
    \includegraphics[width=2.5in]{graphics/blf/DVW.jpg}
\end{center}\\
\begin{itemize}
...
\begin{center}
    \includegraphics[width=4.5in]{graphics/blf/screens/DanzEtAl_Choice.png}
\end{center}    
\begin{itemize}
...
\begin{frame}{Our Choice Interface: NoInfo}
    \begin{center}
        \includegraphics[width=4in]{graphics/blf/screens/Choice_NoInfo.png}
    \end{center}
\end{frame}
}
...
\begin{frame}{Our Choice Interface: BQSR}
    \begin{center}
        \includegraphics[width=2in]{graphics/blf/screens/Choice_BSR.png}
    \end{center}
\end{frame}
}
...
\begin{frame}{Our Choice Interface: MPL}
    \begin{center}
        \includegraphics[width=2.7in]{graphics/blf/screens/Choice_MPL.png}
    \end{center}
\end{frame}
}
...
\begin{frame}{Robust Replication Results}
    \begin{center}
        \includegraphics[width=4.4in]{graphics/blf/Misreporting_Replication.png}
    \end{center}
\end{frame}
}
...
\begin{center}
        \includegraphics[width=1.5in]{graphics/blf/twojars.jpg}\br
\end{center}
\begin{itemize}
    \item One Blue Draw:
    \begin{itemize}
...
\begin{tabular}{rccc}
     & & & Median \\
     &  \includegraphics[width=0.6in]{graphics/blf/urn.jpg} & \includegraphics[width=1in]{graphics/blf/twojarsempty.jpg} & \includegraphics[width=0.6in]{graphics/blf/spin3.jpg} \\
...
\begin{tabular}{rccc}
     ...
     &  \includegraphics[width=0.6in]{graphics/blf/spin3.jpg} & \includegraphics[width=0.6in]{graphics/blf/spin6.jpg} & \includegraphics[width=1in]{graphics/blf/twojars.jpg} \\
...
\includegraphics[width=3in]{graphics/blf/HealyEtAlSignalStructure.png}
\end{frame}

\begin{frame}{An Experimental Test}
Measures of Performance:
\includegraphics[width=2.8in]{graphics/blf/HealyEtAlInconsistent.png}\\
...
\begin{center}
    \includegraphics[height=2.8in]{graphics/blf/HealyEtAl1.png}
\end{center}
\end{frame}
...
\begin{center}
    \includegraphics[width=3in]{graphics/blf/HealyEtAlInconsistentResults.png}
\end{center}
\end{frame}

\begin{frame}{An Experimental Test}
Measures of Performance:
\includegraphics[width=2.8in]{graphics/blf/HealyEtAlMirages.png}\\
3. Mirages\\
4. No trade!    
\end{frame}
...
\begin{center}
    \includegraphics[width=4.2in]{graphics/blf/HealyEtAlMiragesResults.png}
\end{center}
\end{frame}
...
Summary:\\
\begin{center}
    \includegraphics[width=4.2in]{graphics/blf/HealyEtAlResultsSummary.png}
\end{center}
\end{frame}
