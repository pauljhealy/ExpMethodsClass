...
\begin{frame}{Cox, Sadiraj \& Schmidt (2015)}
    \begin{center}
        \includegraphics[width=4in]{graphics/mono/CoxEtAl1.png}
    \end{center}
...
\begin{frame}{Cox, Sadiraj \& Schmidt (2015)}
    \begin{center}
        \includegraphics[width=4in]{graphics/mono/CoxEtAl2.png}
    \end{center}
...
\end{itemize}    
\begin{center}
    \includegraphics[width=3.5in]{graphics/mono/StarmerSugden1.png}
\end{center}
...
\begin{frame}
  ...
  \begin{center}
        \includegraphics[width=3.5in]{graphics/mono/BrownHealyLitReview2.png}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \centering
  \begin{figure}
    \includegraphics[width=3.5in]{graphics/mono/ScreenShotL2.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \centering
  \begin{figure}
    \includegraphics[width=4.5in]{graphics/mono/TreatmentList.png}
  \end{figure}
  \br
  \begin{itemize}
...
\begin{frame}
  ...
  Row 14:\\
    \centering
  \begin{figure}
    \includegraphics[width=4.5in]{graphics/mono/ResultsList.png}
  \end{figure}
  \br
  \begin{itemize}
...
\begin{frame}
  ...
  \centering
  \begin{figure}
    \includegraphics[width=4.5in]{graphics/mono/TreatmentsAll.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  \frametitle{The Results}
    \centering
  \begin{figure}
    \includegraphics[width=4.5in]{graphics/mono/ResultsAll.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \centering
  \includegraphics[width=3in]{graphics/mono/BrownHealySwitchBacks.png}\\
...
\begin{center}
    \includegraphics[width=3in]{graphics/mono/BrownHealyChoicesByRow.png}
\end{center}
...
\begin{frame}
  ...
  \begin{center}
   \includegraphics[width=4.5in]{graphics/mono/BrownHealyLitReview1.png}
  \end{center}
\end{frame}
...
\begin{center}
    \includegraphics[width=2in]{graphics/mono/twojars.png}\\
\begin{tabular}{|r|l|}
\hline
...
Picking {\color{red}U}{\color{blue}U}:
    \begin{center}
        \begin{tabular}{ccc}
            ...
            \includegraphics[width=2in]{graphics/mono/trees_coinfirst_2.png} &              & \includegraphics[width=2in]{graphics/mono/trees_ballfirst.png}\\
             & & \\
...
\begin{frame}{BHL22: Results}
    \includegraphics[width=4in]{graphics/mono/BHL22_Stacked_Raw.pdf}
\end{frame}

\begin{frame}{BHL22: Story 1}
    \includegraphics[width=4in]{graphics/mono/BHL22_Stacked.pdf}
\end{frame}

\begin{frame}{BHL22: Story 2}
    \includegraphics[width=4in]{graphics/mono/BHL22_Stacked_Mixing.pdf}
