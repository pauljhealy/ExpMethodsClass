...
\begin{frame}{Flood-Dresher: De Herdt (2003) analysis}
    \begin{center}
...
\includegraphics[height=0.5in]{LectureSlides/graphics/history/ChamberlinMug.png} Edward H. Chamberlin
\begin{itemize}
    \item ``Father of IO'' 
    \begin{itemize}
...
\begin{itemize}
    ...
    \item  Price $p$, Benefit $a$, with $a > p > a/n$ (often $p=1$)
\end{itemize}
...
\nocite{KagelRoth1995,Thurstone1931,WallisFriedman1942,RousseasHart1951,VonNeumannMorgenstern1944,vonNeumann1928,Morgenstern1935,Morgenstern2002,MostellerNogee1951,DeHerdt2003,Schelling1957,SuppesAtkinson1960,Chamberlin1948,SiegelFouraker1960,Ledyard1995,MarwellAmes1981,IsaacEtAl1985,KimWalker1984,IsaacEtAl1984a}
