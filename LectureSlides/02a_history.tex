...
\includegraphics[width=0.3in]{graphics/history/ThurstoneMug.png} Louis Leon (L.L.) Thurstone 
\begin{itemize}
...
\begin{center}
\includegraphics[width=2in]{graphics/history/Thurstone00.png}
\end{center}
...
\begin{frame}{Thurstone (1931)}
\begin{center}
    \includegraphics[width=3in]{graphics/history/Thurstone01.png}
\end{center}
...
\begin{frame}{Thurstone (1931)}
\begin{center}
    \includegraphics[width=3in]{graphics/history/Thurstone02.png}
\end{center}
...
\begin{frame}{Thurstone (1931)}
\begin{center}
    \includegraphics[width=2.5in]{graphics/history/Thurstone03.png}
\end{center}
...
\includegraphics[height=0.5in]{graphics/history/WallisMug.png} \includegraphics[height=0.5in]{graphics/history/FriedmanMug.png} W. Allen Wallis \& Milton Friedman (1942)
...
\includegraphics[height=0.4in]{graphics/history/RousseasMug.png}\includegraphics[height=0.4in]{graphics/history/HartMug.png}
Stephen Rousseas \& Albert Hart (Student/Prof, Columbia)
\begin{itemize}
    \item Wanted real incentives... \onslide<2->{plates of eggs \& bacon!!}
\end{itemize}
\centering
\onslide<2->{\includegraphics[width=1.6in]{graphics/history/RousseasHart1.png}}
\end{frame}
...
\begin{frame}{Rousseas \& Hart (1951)}
    \begin{center}
        \includegraphics[width=2in]{graphics/history/RousseasHart2.png}
    \end{center}
...
\begin{frame}{Rousseas \& Hart (1951)}
  \begin{center}
      \includegraphics[width=2.5in]{graphics/history/RousseasHart3.png}
  \end{center}
...
\begin{frame}{Rousseas \& Hart (1951)}
\begin{center}
      \includegraphics[width=2.5in]{graphics/history/RousseasHart4.png}
  \end{center}
...
\begin{frame}{Rousseas \& Hart (1951)}
\begin{center}
      \includegraphics[width=3in]{graphics/history/RousseasHart5.png}
  \end{center}
...
\includegraphics[height=0.5in]{graphics/history/vonNeumannMug.png}\includegraphics[height=0.5in]{graphics/history/Morgenstern.png} John von Neumann \& Oskar Morgenstern
\begin{itemize}
...
\begin{frame}{Expected Utility}
    ...
    \begin{center}
        \includegraphics[width=2in]{graphics/history/Simplex1.png}
    \end{center}
\end{frame}
...
\begin{frame}{Allais Paradox}
    ...
    \begin{column}{0.5\textwidth}
        \begin{center}
            \includegraphics[width=2in]{graphics/history/Simplex2.png}
        \end{center}
    \end{column}
    \end{columns}    
    \begin{align*}
...
\begin{frame}{Mosteller \& Nogee (1951)}
\centering
\includegraphics[width=3in]{graphics/history/MostellerNogee1.png}\\
...
\begin{frame}{Mosteller \& Nogee (1951)}
\centering
\includegraphics[width=4in]{graphics/history/MostellerNogee3.png}\\
...
\begin{frame}{Mosteller \& Nogee (1951)}
\centering
\includegraphics[width=4in]{graphics/history/MostellerNogee4.png}\\
...
\begin{frame}{The Flood-Dresher Experiment}
    ...
    \end{itemize}
    \begin{center}
        \includegraphics[width=3in]{graphics/history/FloodDresher.png}
    \end{center}
...
\begin{frame}{Flood-Dresher}
    \begin{center}
        \includegraphics[width=4in]{graphics/history/FloodDresher2.png}
    \end{center}
\end{frame}
...
\begin{frame}{Flood-Dresher}
    \begin{center}
        \includegraphics[height=3in]{graphics/history/FloodDresher3.png}
    \end{center}
\end{frame}

\begin{frame}{Flood-Dresher}
    \begin{center}
        \includegraphics[width=4in]{graphics/history/FloodDresher4.png}
    \end{center}
\end{frame}

\begin{frame}{Flood-Dresher}
    \begin{center}
        \includegraphics[width=4in]{graphics/history/FloodDresher5.png}
    \end{center}
\end{frame}
...
\begin{frame}{Flood-Dresher: De Hert (2003) analysis}
    \begin{center}
        \includegraphics[height=2.5in]{graphics/history/FloodDresher6.png}
    \end{center}
...
\end{itemize}
\begin{center}
    \includegraphics[width=1.75in]{graphics/history/NashMug.png}
\end{center}
\end{frame}
...
\includegraphics[height=0.5in]{graphics/history/ChamberlainMug.png} Edward H. Chamberlain
\begin{itemize}
    \item ``Father of IO'' 
    \begin{itemize}
...
\end{itemize}
\begin{center}
    \includegraphics[height=1.75in]{graphics/history/Chamberlin1.png}
\end{center}
\end{frame}

\begin{frame}{Edward Chamberlin}
\begin{center}
    \includegraphics[height=1.5in]{graphics/history/Chamberlin1.png}
\end{center}
Main result:
\begin{itemize}
...
\includegraphics[height=0.4in]{graphics/history/SmithMug.png}\includegraphics[height=0.4in]{graphics/history/PlottMug.png} Vernon Smith \& Charlie Plott
\begin{itemize}
...
\includegraphics[height=0.4in]{graphics/history/SiegelMug.png} Sidney Siegel \& Lawrence Fouraker
\begin{itemize}
...
\includegraphics[width=0.4in]{graphics/history/LedyardMug.png} John Ledyard
...
\includegraphics[height=0.4in]{graphics/history/OstromMug.png} Elinor ``Lin'' Ostrom
\begin{itemize}
