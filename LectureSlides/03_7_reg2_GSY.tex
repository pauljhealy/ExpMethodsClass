...
\begin{figure}[ht]
        \centering
        \includegraphics[scale=0.37]{LectureSlides/graphics/reg2/screenshots/example_anova.png}
        \label{fig:anova}
    \end{figure}
...
\begin{figure}[ht]
        \centering
        \includegraphics[scale=0.68]{LectureSlides/graphics/reg2/screenshots/anova.png}
        \label{fig:anova}
    \end{figure}
...
\begin{figure}[ht]
        \centering
        \includegraphics[scale=0.62]{LectureSlides/graphics/reg2/screenshots/reg.png}
        \label{fig:anova}
    \end{figure}
    \begin{enumerate}
...
\begin{figure}[ht]
        \centering
        \includegraphics[scale=0.68]{LectureSlides/graphics/reg2/screenshots/anova_2.png}
        \label{fig:anova2}
    \end{figure}
