...
% Title page info
\title[Incentives in Experiments: Theory]{ExpEcon Methods:\\Clever Elicitations \& Choice Process Data (Very Incomplete)}\author[ECON 8877]{ECON 8877\\P.J. Healy\\Parts thanks to Kirby Nielsen} \color{metrop}
\institute[OSU]{}
...
\begin{center}
    \includegraphics[width=\textwidth]{LectureSlides/graphics/clever/s10c3.png}
\end{center}    
\end{frame}

\begin{frame}{Size 20, Complexity 7}
\begin{center}
    \includegraphics[width=\textwidth]{LectureSlides/graphics/clever/s20c7.png}
\end{center}    
\end{frame}
...
\begin{center}
    \includegraphics[width=\textwidth]{LectureSlides/graphics/clever/cdm1.png}
\end{center}    
\end{frame}
...
\begin{frame}{Condition 1}
\begin{center}
    \includegraphics[width=\textwidth]{LectureSlides/graphics/clever/cdm2.png}
\end{center}    
\end{frame}
...
\begin{frame}{Condition 1}
\begin{center}
    \includegraphics[width=\textwidth]{LectureSlides/graphics/clever/cdm3.png}
\end{center}    
\end{frame}
