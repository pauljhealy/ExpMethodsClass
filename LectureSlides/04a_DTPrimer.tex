...
\begin{center}
    \includegraphics[width=2.5in]{graphics/ach/trees_marblefirst.png}\\
...
\begin{frame}{Allais Paradox}
    ...
    \end{itemize}
    \begin{center}
        \includegraphics[width=3in]{graphics/ach/AllaisCurves.png}\\
...
\end{enumerate}
\begin{center}
    \includegraphics[width=1in]{graphics/ach/RDUCurves.png}
\end{center}
\end{frame}
...
\end{enumerate}
\begin{center}
    \includegraphics[width=1.5in]{graphics/ach/CEU.png}
\end{center}
\end{frame}
...
\includegraphics[height=0.6in]{graphics/ach/RamseyMug.png} Frank Plumpton Ramsey
\begin{itemize}
...
\includegraphics[width=0.4in]{graphics/ach/EllsbergMug.png} Daniel Ellsberg
\begin{itemize}
...
\includegraphics[height=0.4in]{graphics/ach/KnightMug.png} Frank Knight
\begin{itemize}
...
\includegraphics[height=0.4in]{graphics/ach/SchmeidlerMug.png} David Schmeidler
\begin{itemize}
...
\includegraphics[height=0.4in]{graphics/ach/AumannMug.png} Robert Aumann
\begin{itemize}
...
\end{itemize}
\includegraphics[height=0.3in]{graphics/ach/AnscombeMug.png} Frank Anscombe
\begin{itemize}
...
\begin{frame}{Schmeidler's Definition of Ambiguity Aversion}
\begin{center}
    \includegraphics[width=3.75in]{graphics/ach/ConvexAmbiguityPrefs.png}
\end{center}
...
\begin{frame}{Schmeidler's Definition of Ambiguity Aversion}
\begin{center}
    \includegraphics[width=3.75in]{graphics/ach/ConvexAmbiguityPrefs2.png}
\end{center}
...
\begin{frame}{Choquet EU (Schmeidler 1989)}
\begin{center}
    \includegraphics[width=2in]{graphics/ach/ConvexAmbiguityPrefs2.png}
\end{center}
...
\begin{center}
    \includegraphics[width=1.5in]{graphics/ach/trees_marblefirst.png} \hspace{0.in} \includegraphics[width=1.5in]{graphics/ach/trees_coinfirst.png}
\end{center}
...
\begin{center}
    \begin{tabular}{ccc}
    \includegraphics[height=2in]{graphics/ach/threestage_coinfirst.png}     &  & \includegraphics[height=2in]{graphics/ach/threestage_coinsecond.png} \\
